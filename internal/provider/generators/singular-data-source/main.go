...
var (
	ccTypeSchemaFile = flag.String("ccschema", "", "Cloud Control resource type schema file; required")
...
func main() {
	...
	if len(args) < 2 || *tfDataSourceType == "" || *ccTypeSchemaFile == "" {
		flag.Usage()
		os.Exit(2)
	}
...
func NewGenerator() *Generator {
	return &Generator{
		...
		cfTypeSchemaFile: *ccTypeSchemaFile,
