...
func init() {
	registry.AddDataSourceFactory("bytepluscc_firewallcenter_dns_control_policy", dnsControlPolicyDataSource)
}

// dnsControlPolicyDataSource returns the Terraform bytepluscc_firewallcenter_dns_control_policy data source.
...
func dnsControlPolicyDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::FireWallCenter::DnsControlPolicy",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::FireWallCenter::DnsControlPolicy").WithTerraformTypeName("bytepluscc_firewallcenter_dns_control_policy")
