...
func init() {
	registry.AddDataSourceFactory("bytepluscc_transitrouter_transit_router_route_entry", transitRouterRouteEntryDataSource)
}

// transitRouterRouteEntryDataSource returns the Terraform bytepluscc_transitrouter_transit_router_route_entry data source.
...
func transitRouterRouteEntryDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TransitRouter::TransitRouterRouteEntry",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TransitRouter::TransitRouterRouteEntry").WithTerraformTypeName("bytepluscc_transitrouter_transit_router_route_entry")
