...
func init() {
	registry.AddDataSourceFactory("bytepluscc_transitrouter_peer_attachment", peerAttachmentDataSource)
}

// peerAttachmentDataSource returns the Terraform bytepluscc_transitrouter_peer_attachment data source.
...
func peerAttachmentDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TransitRouter::PeerAttachment",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TransitRouter::PeerAttachment").WithTerraformTypeName("bytepluscc_transitrouter_peer_attachment")
