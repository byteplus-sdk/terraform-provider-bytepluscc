...
func init() {
	registry.AddDataSourceFactory("bytepluscc_transitrouter_vpn_attachment", vpnAttachmentDataSource)
}

// vpnAttachmentDataSource returns the Terraform bytepluscc_transitrouter_vpn_attachment data source.
...
func vpnAttachmentDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TransitRouter::VpnAttachment",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TransitRouter::VpnAttachment").WithTerraformTypeName("bytepluscc_transitrouter_vpn_attachment")
