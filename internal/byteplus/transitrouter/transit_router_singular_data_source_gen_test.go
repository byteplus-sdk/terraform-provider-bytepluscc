...
func TestAccByteplusTransitRouterTransitRouterDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::TransitRouter::TransitRouter", "bytepluscc_transitrouter_transit_router", "test")
...
func TestAccByteplusTransitRouterTransitRouterDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::TransitRouter::TransitRouter", "bytepluscc_transitrouter_transit_router", "test")
