...
func init() {
	registry.AddDataSourceFactory("bytepluscc_transitrouter_vpc_attachment", vpcAttachmentDataSource)
}

// vpcAttachmentDataSource returns the Terraform bytepluscc_transitrouter_vpc_attachment data source.
...
func vpcAttachmentDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TransitRouter::VpcAttachment",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TransitRouter::VpcAttachment").WithTerraformTypeName("bytepluscc_transitrouter_vpc_attachment")
