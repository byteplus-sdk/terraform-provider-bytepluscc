...
func init() {
	registry.AddDataSourceFactory("bytepluscc_transitrouter_transit_router", transitRouterDataSource)
}

// transitRouterDataSource returns the Terraform bytepluscc_transitrouter_transit_router data source.
...
func transitRouterDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TransitRouter::TransitRouter",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TransitRouter::TransitRouter").WithTerraformTypeName("bytepluscc_transitrouter_transit_router")
