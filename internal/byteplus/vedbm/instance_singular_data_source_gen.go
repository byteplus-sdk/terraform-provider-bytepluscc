...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vedbm_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_vedbm_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEDBM::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEDBM::Instance").WithTerraformTypeName("bytepluscc_vedbm_instance")
