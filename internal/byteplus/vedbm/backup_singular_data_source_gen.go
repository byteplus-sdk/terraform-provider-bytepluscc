...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vedbm_backup", backupDataSource)
}

// backupDataSource returns the Terraform bytepluscc_vedbm_backup data source.
...
func backupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEDBM::Backup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEDBM::Backup").WithTerraformTypeName("bytepluscc_vedbm_backup")
