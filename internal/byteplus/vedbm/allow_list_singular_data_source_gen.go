...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vedbm_allow_list", allowListDataSource)
}

// allowListDataSource returns the Terraform bytepluscc_vedbm_allow_list data source.
...
func allowListDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEDBM::AllowList",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEDBM::AllowList").WithTerraformTypeName("bytepluscc_vedbm_allow_list")
