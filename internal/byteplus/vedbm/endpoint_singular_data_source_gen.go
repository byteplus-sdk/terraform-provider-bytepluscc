...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vedbm_endpoint", endpointDataSource)
}

// endpointDataSource returns the Terraform bytepluscc_vedbm_endpoint data source.
...
func endpointDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEDBM::Endpoint",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEDBM::Endpoint").WithTerraformTypeName("bytepluscc_vedbm_endpoint")
