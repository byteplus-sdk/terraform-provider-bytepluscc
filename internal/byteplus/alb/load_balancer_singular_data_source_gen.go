...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_load_balancer", loadBalancerDataSource)
}

// loadBalancerDataSource returns the Terraform bytepluscc_alb_load_balancer data source.
...
func loadBalancerDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::LoadBalancer",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::LoadBalancer").WithTerraformTypeName("bytepluscc_alb_load_balancer")
