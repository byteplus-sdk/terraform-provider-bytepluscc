...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_acl", aCLDataSource)
}

// aCLDataSource returns the Terraform bytepluscc_alb_acl data source.
...
func aCLDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::ACL",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::ACL").WithTerraformTypeName("bytepluscc_alb_acl")
