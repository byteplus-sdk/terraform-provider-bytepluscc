...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_rule", ruleDataSource)
}

// ruleDataSource returns the Terraform bytepluscc_alb_rule data source.
...
func ruleDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::Rule",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::Rule").WithTerraformTypeName("bytepluscc_alb_rule")
