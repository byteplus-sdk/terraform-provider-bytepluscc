...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_health_check_template", healthCheckTemplateDataSource)
}

// healthCheckTemplateDataSource returns the Terraform bytepluscc_alb_health_check_template data source.
...
func healthCheckTemplateDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::HealthCheckTemplate",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::HealthCheckTemplate").WithTerraformTypeName("bytepluscc_alb_health_check_template")
