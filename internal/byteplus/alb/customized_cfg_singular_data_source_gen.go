...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_customized_cfg", customizedCfgDataSource)
}

// customizedCfgDataSource returns the Terraform bytepluscc_alb_customized_cfg data source.
...
func customizedCfgDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::CustomizedCfg",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::CustomizedCfg").WithTerraformTypeName("bytepluscc_alb_customized_cfg")
