...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_certificate", certificateDataSource)
}

// certificateDataSource returns the Terraform bytepluscc_alb_certificate data source.
...
func certificateDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::Certificate",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::Certificate").WithTerraformTypeName("bytepluscc_alb_certificate")
