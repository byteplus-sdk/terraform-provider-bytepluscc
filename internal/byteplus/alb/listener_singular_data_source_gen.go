...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_listener", listenerDataSource)
}

// listenerDataSource returns the Terraform bytepluscc_alb_listener data source.
...
func listenerDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::Listener",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::Listener").WithTerraformTypeName("bytepluscc_alb_listener")
