...
func init() {
	registry.AddDataSourceFactory("bytepluscc_alb_server_group", serverGroupDataSource)
}

// serverGroupDataSource returns the Terraform bytepluscc_alb_server_group data source.
...
func serverGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ALB::ServerGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ALB::ServerGroup").WithTerraformTypeName("bytepluscc_alb_server_group")
