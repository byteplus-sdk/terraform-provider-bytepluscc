...
func TestAccByteplusBMQGroupDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::BMQ::Group", "bytepluscc_bmq_group", "test")
...
func TestAccByteplusBMQGroupDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::BMQ::Group", "bytepluscc_bmq_group", "test")
