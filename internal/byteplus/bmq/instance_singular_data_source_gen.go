...
func init() {
	registry.AddDataSourceFactory("bytepluscc_bmq_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_bmq_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::BMQ::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::BMQ::Instance").WithTerraformTypeName("bytepluscc_bmq_instance")
