...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vmp_workspace", workspaceDataSource)
}

// workspaceDataSource returns the Terraform bytepluscc_vmp_workspace data source.
...
func workspaceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VMP::Workspace",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VMP::Workspace").WithTerraformTypeName("bytepluscc_vmp_workspace")
