...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_ipv6_gateway", ipv6GatewayDataSource)
}

// ipv6GatewayDataSource returns the Terraform bytepluscc_vpc_ipv6_gateway data source.
...
func ipv6GatewayDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::Ipv6Gateway",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::Ipv6Gateway").WithTerraformTypeName("bytepluscc_vpc_ipv6_gateway")
