...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_eip", eIPDataSource)
}

// eIPDataSource returns the Terraform bytepluscc_vpc_eip data source.
...
func eIPDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::EIP",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::EIP").WithTerraformTypeName("bytepluscc_vpc_eip")
