...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_traffic_mirror_filter_rule", trafficMirrorFilterRuleDataSource)
}

// trafficMirrorFilterRuleDataSource returns the Terraform bytepluscc_vpc_traffic_mirror_filter_rule data source.
...
func trafficMirrorFilterRuleDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::TrafficMirrorFilterRule",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::TrafficMirrorFilterRule").WithTerraformTypeName("bytepluscc_vpc_traffic_mirror_filter_rule")
