...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_traffic_mirror_filter", trafficMirrorFilterDataSource)
}

// trafficMirrorFilterDataSource returns the Terraform bytepluscc_vpc_traffic_mirror_filter data source.
...
func trafficMirrorFilterDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::TrafficMirrorFilter",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::TrafficMirrorFilter").WithTerraformTypeName("bytepluscc_vpc_traffic_mirror_filter")
