...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_traffic_mirror_target", trafficMirrorTargetDataSource)
}

// trafficMirrorTargetDataSource returns the Terraform bytepluscc_vpc_traffic_mirror_target data source.
...
func trafficMirrorTargetDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::TrafficMirrorTarget",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::TrafficMirrorTarget").WithTerraformTypeName("bytepluscc_vpc_traffic_mirror_target")
