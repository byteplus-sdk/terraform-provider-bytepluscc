...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_traffic_mirror_session", trafficMirrorSessionDataSource)
}

// trafficMirrorSessionDataSource returns the Terraform bytepluscc_vpc_traffic_mirror_session data source.
...
func trafficMirrorSessionDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::TrafficMirrorSession",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::TrafficMirrorSession").WithTerraformTypeName("bytepluscc_vpc_traffic_mirror_session")
