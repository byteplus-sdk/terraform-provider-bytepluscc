...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_security_group", securityGroupDataSource)
}

// securityGroupDataSource returns the Terraform bytepluscc_vpc_security_group data source.
...
func securityGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::SecurityGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::SecurityGroup").WithTerraformTypeName("bytepluscc_vpc_security_group")
