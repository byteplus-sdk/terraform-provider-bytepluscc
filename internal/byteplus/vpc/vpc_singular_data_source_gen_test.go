...
func TestAccByteplusVPCVPCDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::VPC::VPC", "bytepluscc_vpc_vpc", "test")
...
func TestAccByteplusVPCVPCDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::VPC::VPC", "bytepluscc_vpc_vpc", "test")
