...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_route_table", routeTableDataSource)
}

// routeTableDataSource returns the Terraform bytepluscc_vpc_route_table data source.
...
func routeTableDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::RouteTable",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::RouteTable").WithTerraformTypeName("bytepluscc_vpc_route_table")
