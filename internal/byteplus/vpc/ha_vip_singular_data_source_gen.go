...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_ha_vip", hAVIPDataSource)
}

// hAVIPDataSource returns the Terraform bytepluscc_vpc_ha_vip data source.
...
func hAVIPDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::HAVIP",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::HAVIP").WithTerraformTypeName("bytepluscc_vpc_ha_vip")
