...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_vpc", vPCDataSource)
}

// vPCDataSource returns the Terraform bytepluscc_vpc_vpc data source.
...
func vPCDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::VPC",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::VPC").WithTerraformTypeName("bytepluscc_vpc_vpc")
