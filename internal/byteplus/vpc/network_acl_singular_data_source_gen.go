...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_network_acl", networkAclDataSource)
}

// networkAclDataSource returns the Terraform bytepluscc_vpc_network_acl data source.
...
func networkAclDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::NetworkAcl",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::NetworkAcl").WithTerraformTypeName("bytepluscc_vpc_network_acl")
