...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_prefix_list", prefixListDataSource)
}

// prefixListDataSource returns the Terraform bytepluscc_vpc_prefix_list data source.
...
func prefixListDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::PrefixList",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::PrefixList").WithTerraformTypeName("bytepluscc_vpc_prefix_list")
