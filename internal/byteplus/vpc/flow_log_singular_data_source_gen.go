...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_flow_log", flowLogDataSource)
}

// flowLogDataSource returns the Terraform bytepluscc_vpc_flow_log data source.
...
func flowLogDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::FlowLog",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::FlowLog").WithTerraformTypeName("bytepluscc_vpc_flow_log")
