...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_ipv6_address_bandwidth", ipv6AddressBandwidthDataSource)
}

// ipv6AddressBandwidthDataSource returns the Terraform bytepluscc_vpc_ipv6_address_bandwidth data source.
...
func ipv6AddressBandwidthDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::Ipv6AddressBandwidth",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::Ipv6AddressBandwidth").WithTerraformTypeName("bytepluscc_vpc_ipv6_address_bandwidth")
