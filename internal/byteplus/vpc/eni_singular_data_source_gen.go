...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_eni", eNIDataSource)
}

// eNIDataSource returns the Terraform bytepluscc_vpc_eni data source.
...
func eNIDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::ENI",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::ENI").WithTerraformTypeName("bytepluscc_vpc_eni")
