...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_bandwidth_package", bandwidthPackageDataSource)
}

// bandwidthPackageDataSource returns the Terraform bytepluscc_vpc_bandwidth_package data source.
...
func bandwidthPackageDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::BandwidthPackage",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::BandwidthPackage").WithTerraformTypeName("bytepluscc_vpc_bandwidth_package")
