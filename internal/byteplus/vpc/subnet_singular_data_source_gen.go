...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpc_subnet", subnetDataSource)
}

// subnetDataSource returns the Terraform bytepluscc_vpc_subnet data source.
...
func subnetDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPC::Subnet",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPC::Subnet").WithTerraformTypeName("bytepluscc_vpc_subnet")
