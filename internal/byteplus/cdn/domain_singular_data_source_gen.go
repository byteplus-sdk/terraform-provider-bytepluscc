...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cdn_domain", domainDataSource)
}

// domainDataSource returns the Terraform bytepluscc_cdn_domain data source.
...
func domainDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CDN::Domain",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CDN::Domain").WithTerraformTypeName("bytepluscc_cdn_domain")
