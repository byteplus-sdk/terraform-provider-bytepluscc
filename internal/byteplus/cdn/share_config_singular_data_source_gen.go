...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cdn_share_config", shareConfigDataSource)
}

// shareConfigDataSource returns the Terraform bytepluscc_cdn_share_config data source.
...
func shareConfigDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CDN::ShareConfig",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CDN::ShareConfig").WithTerraformTypeName("bytepluscc_cdn_share_config")
