...
func init() {
	registry.AddDataSourceFactory("bytepluscc_organization_service_control_policy", serviceControlPolicyDataSource)
}

// serviceControlPolicyDataSource returns the Terraform bytepluscc_organization_service_control_policy data source.
...
func serviceControlPolicyDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Organization::ServiceControlPolicy",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Organization::ServiceControlPolicy").WithTerraformTypeName("bytepluscc_organization_service_control_policy")
