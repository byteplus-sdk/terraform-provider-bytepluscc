...
func init() {
	registry.AddDataSourceFactory("bytepluscc_organization_organization", organizationDataSource)
}

// organizationDataSource returns the Terraform bytepluscc_organization_organization data source.
...
func organizationDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Organization::Organization",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Organization::Organization").WithTerraformTypeName("bytepluscc_organization_organization")
