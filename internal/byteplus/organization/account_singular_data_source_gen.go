...
func init() {
	registry.AddDataSourceFactory("bytepluscc_organization_account", accountDataSource)
}

// accountDataSource returns the Terraform bytepluscc_organization_account data source.
...
func accountDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Organization::Account",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Organization::Account").WithTerraformTypeName("bytepluscc_organization_account")
