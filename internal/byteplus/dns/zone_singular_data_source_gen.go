...
func init() {
	registry.AddDataSourceFactory("bytepluscc_dns_zone", zoneDataSource)
}

// zoneDataSource returns the Terraform bytepluscc_dns_zone data source.
...
func zoneDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::DNS::Zone",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::DNS::Zone").WithTerraformTypeName("bytepluscc_dns_zone")
