...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdspostgresql_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_rdspostgresql_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSPostgreSQL::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSPostgreSQL::Instance").WithTerraformTypeName("bytepluscc_rdspostgresql_instance")
