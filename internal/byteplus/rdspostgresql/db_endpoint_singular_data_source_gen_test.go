...
func TestAccByteplusRDSPostgreSQLDBEndpointDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::RDSPostgreSQL::DBEndpoint", "bytepluscc_rdspostgresql_db_endpoint", "test")
...
func TestAccByteplusRDSPostgreSQLDBEndpointDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::RDSPostgreSQL::DBEndpoint", "bytepluscc_rdspostgresql_db_endpoint", "test")
