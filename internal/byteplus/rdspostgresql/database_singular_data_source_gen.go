...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdspostgresql_database", databaseDataSource)
}

// databaseDataSource returns the Terraform bytepluscc_rdspostgresql_database data source.
...
func databaseDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSPostgreSQL::Database",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSPostgreSQL::Database").WithTerraformTypeName("bytepluscc_rdspostgresql_database")
