...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdspostgresql_db_endpoint", dBEndpointDataSource)
}

// dBEndpointDataSource returns the Terraform bytepluscc_rdspostgresql_db_endpoint data source.
...
func dBEndpointDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSPostgreSQL::DBEndpoint",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSPostgreSQL::DBEndpoint").WithTerraformTypeName("bytepluscc_rdspostgresql_db_endpoint")
