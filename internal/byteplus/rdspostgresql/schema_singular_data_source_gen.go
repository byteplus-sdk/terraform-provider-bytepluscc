...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdspostgresql_schema", schemaDataSource)
}

// schemaDataSource returns the Terraform bytepluscc_rdspostgresql_schema data source.
...
func schemaDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSPostgreSQL::Schema",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSPostgreSQL::Schema").WithTerraformTypeName("bytepluscc_rdspostgresql_schema")
