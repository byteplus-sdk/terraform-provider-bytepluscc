...
func TestAccByteplusRDSPostgreSQLAllowListDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::RDSPostgreSQL::AllowList", "bytepluscc_rdspostgresql_allow_list", "test")
...
func TestAccByteplusRDSPostgreSQLAllowListDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::RDSPostgreSQL::AllowList", "bytepluscc_rdspostgresql_allow_list", "test")
