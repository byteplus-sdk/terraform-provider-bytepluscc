...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdspostgresql_allow_list", allowListDataSource)
}

// allowListDataSource returns the Terraform bytepluscc_rdspostgresql_allow_list data source.
...
func allowListDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSPostgreSQL::AllowList",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSPostgreSQL::AllowList").WithTerraformTypeName("bytepluscc_rdspostgresql_allow_list")
