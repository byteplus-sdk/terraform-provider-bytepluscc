...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cen_cen", cENDataSource)
}

// cENDataSource returns the Terraform bytepluscc_cen_cen data source.
...
func cENDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CEN::CEN",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CEN::CEN").WithTerraformTypeName("bytepluscc_cen_cen")
