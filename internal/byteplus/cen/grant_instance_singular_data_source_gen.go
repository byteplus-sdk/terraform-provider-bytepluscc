...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cen_grant_instance", grantInstanceDataSource)
}

// grantInstanceDataSource returns the Terraform bytepluscc_cen_grant_instance data source.
...
func grantInstanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CEN::GrantInstance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CEN::GrantInstance").WithTerraformTypeName("bytepluscc_cen_grant_instance")
