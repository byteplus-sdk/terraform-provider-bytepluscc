...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cen_bandwidth_package", bandwidthPackageDataSource)
}

// bandwidthPackageDataSource returns the Terraform bytepluscc_cen_bandwidth_package data source.
...
func bandwidthPackageDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CEN::BandwidthPackage",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CEN::BandwidthPackage").WithTerraformTypeName("bytepluscc_cen_bandwidth_package")
