...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cen_service_route_entry", serviceRouteEntryDataSource)
}

// serviceRouteEntryDataSource returns the Terraform bytepluscc_cen_service_route_entry data source.
...
func serviceRouteEntryDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CEN::ServiceRouteEntry",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CEN::ServiceRouteEntry").WithTerraformTypeName("bytepluscc_cen_service_route_entry")
