...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cen_route_entry", routeEntryDataSource)
}

// routeEntryDataSource returns the Terraform bytepluscc_cen_route_entry data source.
...
func routeEntryDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CEN::RouteEntry",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CEN::RouteEntry").WithTerraformTypeName("bytepluscc_cen_route_entry")
