...
func init() {
	registry.AddDataSourceFactory("bytepluscc_autoscaling_scaling_configuration", scalingConfigurationDataSource)
}

// scalingConfigurationDataSource returns the Terraform bytepluscc_autoscaling_scaling_configuration data source.
...
func scalingConfigurationDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::AutoScaling::ScalingConfiguration",
