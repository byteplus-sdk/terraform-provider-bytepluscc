...
func TestAccByteplusAutoScalingScalingConfigurationDataSource_basic(t *testing.T) {
...
func TestAccByteplusAutoScalingScalingConfigurationDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::AutoScaling::ScalingConfiguration", "bytepluscc_autoscaling_scaling_configuration", "test")
