...
func init() {
	registry.AddDataSourceFactory("bytepluscc_autoscaling_scaling_policy", scalingPolicyDataSource)
}

// scalingPolicyDataSource returns the Terraform bytepluscc_autoscaling_scaling_policy data source.
...
func scalingPolicyDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::AutoScaling::ScalingPolicy",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::AutoScaling::ScalingPolicy").WithTerraformTypeName("bytepluscc_autoscaling_scaling_policy")
