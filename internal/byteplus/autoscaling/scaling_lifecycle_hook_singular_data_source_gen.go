...
func init() {
	registry.AddDataSourceFactory("bytepluscc_autoscaling_scaling_lifecycle_hook", scalingLifecycleHookDataSource)
}

// scalingLifecycleHookDataSource returns the Terraform bytepluscc_autoscaling_scaling_lifecycle_hook data source.
...
func scalingLifecycleHookDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::AutoScaling::ScalingLifecycleHook",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::AutoScaling::ScalingLifecycleHook").WithTerraformTypeName("bytepluscc_autoscaling_scaling_lifecycle_hook")
