...
func init() {
	registry.AddDataSourceFactory("bytepluscc_autoscaling_scaling_group", scalingGroupDataSource)
}

// scalingGroupDataSource returns the Terraform bytepluscc_autoscaling_scaling_group data source.
...
func scalingGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::AutoScaling::ScalingGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::AutoScaling::ScalingGroup").WithTerraformTypeName("bytepluscc_autoscaling_scaling_group")
