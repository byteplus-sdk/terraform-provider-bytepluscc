...
func init() {
	registry.AddDataSourceFactory("bytepluscc_directconnect_direct_connect_gateway", directConnectGatewayDataSource)
}

// directConnectGatewayDataSource returns the Terraform bytepluscc_directconnect_direct_connect_gateway data source.
...
func directConnectGatewayDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::DirectConnect::DirectConnectGateway",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::DirectConnect::DirectConnectGateway").WithTerraformTypeName("bytepluscc_directconnect_direct_connect_gateway")
