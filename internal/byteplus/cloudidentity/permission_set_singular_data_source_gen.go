...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cloudidentity_permission_set", permissionSetDataSource)
}

// permissionSetDataSource returns the Terraform bytepluscc_cloudidentity_permission_set data source.
...
func permissionSetDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CloudIdentity::PermissionSet",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CloudIdentity::PermissionSet").WithTerraformTypeName("bytepluscc_cloudidentity_permission_set")
