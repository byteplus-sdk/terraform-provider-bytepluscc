...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cloudidentity_user", userDataSource)
}

// userDataSource returns the Terraform bytepluscc_cloudidentity_user data source.
...
func userDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CloudIdentity::User",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CloudIdentity::User").WithTerraformTypeName("bytepluscc_cloudidentity_user")
