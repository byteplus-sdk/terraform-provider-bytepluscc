...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cloudidentity_group", groupDataSource)
}

// groupDataSource returns the Terraform bytepluscc_cloudidentity_group data source.
...
func groupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CloudIdentity::Group",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CloudIdentity::Group").WithTerraformTypeName("bytepluscc_cloudidentity_group")
