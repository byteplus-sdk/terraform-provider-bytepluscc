...
func TestAccByteplusCloudIdentityUserDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::CloudIdentity::User", "bytepluscc_cloudidentity_user", "test")
...
func TestAccByteplusCloudIdentityUserDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::CloudIdentity::User", "bytepluscc_cloudidentity_user", "test")
