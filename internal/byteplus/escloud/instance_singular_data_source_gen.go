...
func init() {
	registry.AddDataSourceFactory("bytepluscc_escloud_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_escloud_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ESCloud::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ESCloud::Instance").WithTerraformTypeName("bytepluscc_escloud_instance")
