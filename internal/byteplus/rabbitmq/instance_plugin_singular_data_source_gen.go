...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rabbitmq_instance_plugin", instancePluginDataSource)
}

// instancePluginDataSource returns the Terraform bytepluscc_rabbitmq_instance_plugin data source.
...
func instancePluginDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RabbitMQ::InstancePlugin",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RabbitMQ::InstancePlugin").WithTerraformTypeName("bytepluscc_rabbitmq_instance_plugin")
