...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rabbitmq_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_rabbitmq_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RabbitMQ::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RabbitMQ::Instance").WithTerraformTypeName("bytepluscc_rabbitmq_instance")
