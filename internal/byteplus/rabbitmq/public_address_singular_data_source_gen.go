...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rabbitmq_public_address", publicAddressDataSource)
}

// publicAddressDataSource returns the Terraform bytepluscc_rabbitmq_public_address data source.
...
func publicAddressDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RabbitMQ::PublicAddress",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RabbitMQ::PublicAddress").WithTerraformTypeName("bytepluscc_rabbitmq_public_address")
