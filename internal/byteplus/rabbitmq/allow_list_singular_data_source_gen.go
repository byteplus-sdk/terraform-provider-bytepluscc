...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rabbitmq_allow_list", allowListDataSource)
}

// allowListDataSource returns the Terraform bytepluscc_rabbitmq_allow_list data source.
...
func allowListDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RabbitMQ::AllowList",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RabbitMQ::AllowList").WithTerraformTypeName("bytepluscc_rabbitmq_allow_list")
