...
func init() {
	registry.AddDataSourceFactory("bytepluscc_filenas_snapshot", snapshotDataSource)
}

// snapshotDataSource returns the Terraform bytepluscc_filenas_snapshot data source.
...
func snapshotDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::FileNAS::Snapshot",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::FileNAS::Snapshot").WithTerraformTypeName("bytepluscc_filenas_snapshot")
