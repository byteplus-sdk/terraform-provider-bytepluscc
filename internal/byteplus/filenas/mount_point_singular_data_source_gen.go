...
func init() {
	registry.AddDataSourceFactory("bytepluscc_filenas_mount_point", mountPointDataSource)
}

// mountPointDataSource returns the Terraform bytepluscc_filenas_mount_point data source.
...
func mountPointDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::FileNAS::MountPoint",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::FileNAS::MountPoint").WithTerraformTypeName("bytepluscc_filenas_mount_point")
