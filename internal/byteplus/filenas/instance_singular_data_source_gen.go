...
func init() {
	registry.AddDataSourceFactory("bytepluscc_filenas_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_filenas_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::FileNAS::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::FileNAS::Instance").WithTerraformTypeName("bytepluscc_filenas_instance")
