...
func TestAccByteplusVEFAASFunctionDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::VEFAAS::Function", "bytepluscc_vefaas_function", "test")
...
func TestAccByteplusVEFAASFunctionDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::VEFAAS::Function", "bytepluscc_vefaas_function", "test")
