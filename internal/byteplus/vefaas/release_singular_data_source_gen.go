...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vefaas_release", releaseDataSource)
}

// releaseDataSource returns the Terraform bytepluscc_vefaas_release data source.
...
func releaseDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEFAAS::Release",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEFAAS::Release").WithTerraformTypeName("bytepluscc_vefaas_release")
