...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vefaas_function", functionDataSource)
}

// functionDataSource returns the Terraform bytepluscc_vefaas_function data source.
...
func functionDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEFAAS::Function",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEFAAS::Function").WithTerraformTypeName("bytepluscc_vefaas_function")
