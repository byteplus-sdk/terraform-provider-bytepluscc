...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vefaas_kafka_trigger", kafkaTriggerDataSource)
}

// kafkaTriggerDataSource returns the Terraform bytepluscc_vefaas_kafka_trigger data source.
...
func kafkaTriggerDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEFAAS::KafkaTrigger",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEFAAS::KafkaTrigger").WithTerraformTypeName("bytepluscc_vefaas_kafka_trigger")
