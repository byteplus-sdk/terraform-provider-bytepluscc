...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vefaas_sandbox", sandboxDataSource)
}

// sandboxDataSource returns the Terraform bytepluscc_vefaas_sandbox data source.
...
func sandboxDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEFAAS::Sandbox",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEFAAS::Sandbox").WithTerraformTypeName("bytepluscc_vefaas_sandbox")
