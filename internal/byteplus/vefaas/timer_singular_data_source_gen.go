...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vefaas_timer", timerDataSource)
}

// timerDataSource returns the Terraform bytepluscc_vefaas_timer data source.
...
func timerDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEFAAS::Timer",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEFAAS::Timer").WithTerraformTypeName("bytepluscc_vefaas_timer")
