...
func init() {
	registry.AddDataSourceFactory("bytepluscc_ark_endpoint", endpointDataSource)
}

// endpointDataSource returns the Terraform bytepluscc_ark_endpoint data source.
...
func endpointDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ARK::Endpoint",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ARK::Endpoint").WithTerraformTypeName("bytepluscc_ark_endpoint")
