...
func TestAccByteplusGTMRoutingDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::GTM::Routing", "bytepluscc_gtm_routing", "test")
...
func TestAccByteplusGTMRoutingDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::GTM::Routing", "bytepluscc_gtm_routing", "test")
