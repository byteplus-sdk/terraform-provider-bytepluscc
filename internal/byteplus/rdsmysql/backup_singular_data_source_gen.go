...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdsmysql_backup", backupDataSource)
}

// backupDataSource returns the Terraform bytepluscc_rdsmysql_backup data source.
...
func backupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSMySQL::Backup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSMySQL::Backup").WithTerraformTypeName("bytepluscc_rdsmysql_backup")
