...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdsmysql_endpoint_public_address", endpointPublicAddressDataSource)
}

// endpointPublicAddressDataSource returns the Terraform bytepluscc_rdsmysql_endpoint_public_address data source.
...
func endpointPublicAddressDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSMySQL::EndpointPublicAddress",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSMySQL::EndpointPublicAddress").WithTerraformTypeName("bytepluscc_rdsmysql_endpoint_public_address")
