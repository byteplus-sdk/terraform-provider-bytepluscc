...
func TestAccByteplusRDSMySQLAllowListDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::RDSMySQL::AllowList", "bytepluscc_rdsmysql_allow_list", "test")
...
func TestAccByteplusRDSMySQLAllowListDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::RDSMySQL::AllowList", "bytepluscc_rdsmysql_allow_list", "test")
