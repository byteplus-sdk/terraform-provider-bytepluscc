...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdsmysql_database", databaseDataSource)
}

// databaseDataSource returns the Terraform bytepluscc_rdsmysql_database data source.
...
func databaseDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSMySQL::Database",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSMySQL::Database").WithTerraformTypeName("bytepluscc_rdsmysql_database")
