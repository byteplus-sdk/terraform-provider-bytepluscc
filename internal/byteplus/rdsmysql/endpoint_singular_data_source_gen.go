...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdsmysql_endpoint", endpointDataSource)
}

// endpointDataSource returns the Terraform bytepluscc_rdsmysql_endpoint data source.
...
func endpointDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSMySQL::Endpoint",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSMySQL::Endpoint").WithTerraformTypeName("bytepluscc_rdsmysql_endpoint")
