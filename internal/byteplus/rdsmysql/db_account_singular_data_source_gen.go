...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdsmysql_db_account", dBAccountDataSource)
}

// dBAccountDataSource returns the Terraform bytepluscc_rdsmysql_db_account data source.
...
func dBAccountDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSMySQL::DBAccount",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSMySQL::DBAccount").WithTerraformTypeName("bytepluscc_rdsmysql_db_account")
