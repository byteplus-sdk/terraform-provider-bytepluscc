...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cloudmonitor_contact_group", contactGroupDataSource)
}

// contactGroupDataSource returns the Terraform bytepluscc_cloudmonitor_contact_group data source.
...
func contactGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CloudMonitor::ContactGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CloudMonitor::ContactGroup").WithTerraformTypeName("bytepluscc_cloudmonitor_contact_group")
