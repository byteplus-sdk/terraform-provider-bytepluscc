...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cloudmonitor_rule", ruleDataSource)
}

// ruleDataSource returns the Terraform bytepluscc_cloudmonitor_rule data source.
...
func ruleDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CloudMonitor::Rule",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CloudMonitor::Rule").WithTerraformTypeName("bytepluscc_cloudmonitor_rule")
