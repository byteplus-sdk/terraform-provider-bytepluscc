...
func init() {
	registry.AddDataSourceFactory("bytepluscc_rdsmssql_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_rdsmssql_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::RDSMsSQL::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::RDSMsSQL::Instance").WithTerraformTypeName("bytepluscc_rdsmssql_instance")
