...
func TestAccByteplusPrivateLinkEndpointServiceDataSource_basic(t *testing.T) {
...
func TestAccByteplusPrivateLinkEndpointServiceDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::PrivateLink::EndpointService", "bytepluscc_privatelink_endpoint_service", "test")
