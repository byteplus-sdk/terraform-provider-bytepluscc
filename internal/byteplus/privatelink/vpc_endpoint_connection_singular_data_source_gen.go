...
func init() {
	registry.AddDataSourceFactory("bytepluscc_privatelink_vpc_endpoint_connection", vpcEndpointConnectionDataSource)
}

// vpcEndpointConnectionDataSource returns the Terraform bytepluscc_privatelink_vpc_endpoint_connection data source.
...
func vpcEndpointConnectionDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::PrivateLink::VpcEndpointConnection",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::PrivateLink::VpcEndpointConnection").WithTerraformTypeName("bytepluscc_privatelink_vpc_endpoint_connection")
