...
func init() {
	registry.AddDataSourceFactory("bytepluscc_privatelink_vpc_endpoint", vpcEndpointDataSource)
}

// vpcEndpointDataSource returns the Terraform bytepluscc_privatelink_vpc_endpoint data source.
...
func vpcEndpointDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::PrivateLink::VpcEndpoint",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::PrivateLink::VpcEndpoint").WithTerraformTypeName("bytepluscc_privatelink_vpc_endpoint")
