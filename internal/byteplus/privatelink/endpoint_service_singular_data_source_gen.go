...
func init() {
	registry.AddDataSourceFactory("bytepluscc_privatelink_endpoint_service", endpointServiceDataSource)
}

// endpointServiceDataSource returns the Terraform bytepluscc_privatelink_endpoint_service data source.
...
func endpointServiceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::PrivateLink::EndpointService",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::PrivateLink::EndpointService").WithTerraformTypeName("bytepluscc_privatelink_endpoint_service")
