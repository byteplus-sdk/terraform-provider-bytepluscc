...
func TestAccByteplusPrivateLinkVpcEndpointDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::PrivateLink::VpcEndpoint", "bytepluscc_privatelink_vpc_endpoint", "test")
...
func TestAccByteplusPrivateLinkVpcEndpointDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::PrivateLink::VpcEndpoint", "bytepluscc_privatelink_vpc_endpoint", "test")
