...
func init() {
	registry.AddDataSourceFactory("bytepluscc_natgateway_snatentry", snatentryDataSource)
}

// snatentryDataSource returns the Terraform bytepluscc_natgateway_snatentry data source.
...
func snatentryDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::NatGateway::Snatentry",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::NatGateway::Snatentry").WithTerraformTypeName("bytepluscc_natgateway_snatentry")
