...
func init() {
	registry.AddDataSourceFactory("bytepluscc_natgateway_nat_ip", natIpDataSource)
}

// natIpDataSource returns the Terraform bytepluscc_natgateway_nat_ip data source.
...
func natIpDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::NatGateway::NatIp",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::NatGateway::NatIp").WithTerraformTypeName("bytepluscc_natgateway_nat_ip")
