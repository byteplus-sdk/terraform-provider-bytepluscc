...
func init() {
	registry.AddDataSourceFactory("bytepluscc_natgateway_ngw", nGWDataSource)
}

// nGWDataSource returns the Terraform bytepluscc_natgateway_ngw data source.
...
func nGWDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::NatGateway::NGW",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::NatGateway::NGW").WithTerraformTypeName("bytepluscc_natgateway_ngw")
