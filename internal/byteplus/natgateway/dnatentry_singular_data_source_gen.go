...
func init() {
	registry.AddDataSourceFactory("bytepluscc_natgateway_dnatentry", dnatentryDataSource)
}

// dnatentryDataSource returns the Terraform bytepluscc_natgateway_dnatentry data source.
...
func dnatentryDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::NatGateway::Dnatentry",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::NatGateway::Dnatentry").WithTerraformTypeName("bytepluscc_natgateway_dnatentry")
