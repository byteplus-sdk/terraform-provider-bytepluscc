...
func init() {
	registry.AddDataSourceFactory("bytepluscc_ecs_keypair", keypairDataSource)
}

// keypairDataSource returns the Terraform bytepluscc_ecs_keypair data source.
...
func keypairDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ECS::Keypair",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ECS::Keypair").WithTerraformTypeName("bytepluscc_ecs_keypair")
