...
func init() {
	registry.AddDataSourceFactory("bytepluscc_ecs_deployment_set", deploymentSetDataSource)
}

// deploymentSetDataSource returns the Terraform bytepluscc_ecs_deployment_set data source.
...
func deploymentSetDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ECS::DeploymentSet",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ECS::DeploymentSet").WithTerraformTypeName("bytepluscc_ecs_deployment_set")
