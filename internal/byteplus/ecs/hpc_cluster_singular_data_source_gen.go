...
func init() {
	registry.AddDataSourceFactory("bytepluscc_ecs_hpc_cluster", hpcClusterDataSource)
}

// hpcClusterDataSource returns the Terraform bytepluscc_ecs_hpc_cluster data source.
...
func hpcClusterDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ECS::HpcCluster",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ECS::HpcCluster").WithTerraformTypeName("bytepluscc_ecs_hpc_cluster")
