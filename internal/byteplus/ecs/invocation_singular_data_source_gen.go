...
func init() {
	registry.AddDataSourceFactory("bytepluscc_ecs_invocation", invocationDataSource)
}

// invocationDataSource returns the Terraform bytepluscc_ecs_invocation data source.
...
func invocationDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ECS::Invocation",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ECS::Invocation").WithTerraformTypeName("bytepluscc_ecs_invocation")
