...
func init() {
	registry.AddDataSourceFactory("bytepluscc_ecs_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_ecs_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ECS::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ECS::Instance").WithTerraformTypeName("bytepluscc_ecs_instance")
