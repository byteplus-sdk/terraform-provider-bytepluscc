...
func init() {
	registry.AddDataSourceFactory("bytepluscc_ecs_command", commandDataSource)
}

// commandDataSource returns the Terraform bytepluscc_ecs_command data source.
...
func commandDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::ECS::Command",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::ECS::Command").WithTerraformTypeName("bytepluscc_ecs_command")
