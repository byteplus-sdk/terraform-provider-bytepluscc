...
func init() {
	registry.AddDataSourceFactory("bytepluscc_waf_domain", domainDataSource)
}

// domainDataSource returns the Terraform bytepluscc_waf_domain data source.
...
func domainDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::WAF::Domain",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::WAF::Domain").WithTerraformTypeName("bytepluscc_waf_domain")
