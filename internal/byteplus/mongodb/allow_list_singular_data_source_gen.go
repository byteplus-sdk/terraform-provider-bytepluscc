...
func init() {
	registry.AddDataSourceFactory("bytepluscc_mongodb_allow_list", allowListDataSource)
}

// allowListDataSource returns the Terraform bytepluscc_mongodb_allow_list data source.
...
func allowListDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::MongoDB::AllowList",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::MongoDB::AllowList").WithTerraformTypeName("bytepluscc_mongodb_allow_list")
