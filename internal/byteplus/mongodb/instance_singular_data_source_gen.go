...
func init() {
	registry.AddDataSourceFactory("bytepluscc_mongodb_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_mongodb_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::MongoDB::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::MongoDB::Instance").WithTerraformTypeName("bytepluscc_mongodb_instance")
