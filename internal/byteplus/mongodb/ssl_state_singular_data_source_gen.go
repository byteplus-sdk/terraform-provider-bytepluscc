...
func init() {
	registry.AddDataSourceFactory("bytepluscc_mongodb_ssl_state", sSLStateDataSource)
}

// sSLStateDataSource returns the Terraform bytepluscc_mongodb_ssl_state data source.
...
func sSLStateDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::MongoDB::SSLState",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::MongoDB::SSLState").WithTerraformTypeName("bytepluscc_mongodb_ssl_state")
