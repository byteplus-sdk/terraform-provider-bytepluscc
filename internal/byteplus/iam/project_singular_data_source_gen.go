...
func init() {
	registry.AddDataSourceFactory("bytepluscc_iam_project", projectDataSource)
}

// projectDataSource returns the Terraform bytepluscc_iam_project data source.
...
func projectDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::IAM::Project",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::IAM::Project").WithTerraformTypeName("bytepluscc_iam_project")
