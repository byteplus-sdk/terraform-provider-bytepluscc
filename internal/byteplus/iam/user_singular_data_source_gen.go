...
func init() {
	registry.AddDataSourceFactory("bytepluscc_iam_user", userDataSource)
}

// userDataSource returns the Terraform bytepluscc_iam_user data source.
...
func userDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::IAM::User",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::IAM::User").WithTerraformTypeName("bytepluscc_iam_user")
