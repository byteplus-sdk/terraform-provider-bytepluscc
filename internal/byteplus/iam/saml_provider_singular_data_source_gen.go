...
func init() {
	registry.AddDataSourceFactory("bytepluscc_iam_saml_provider", samlProviderDataSource)
}

// samlProviderDataSource returns the Terraform bytepluscc_iam_saml_provider data source.
...
func samlProviderDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::IAM::SamlProvider",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::IAM::SamlProvider").WithTerraformTypeName("bytepluscc_iam_saml_provider")
