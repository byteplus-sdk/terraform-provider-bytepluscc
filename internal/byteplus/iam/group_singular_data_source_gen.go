...
func init() {
	registry.AddDataSourceFactory("bytepluscc_iam_group", groupDataSource)
}

// groupDataSource returns the Terraform bytepluscc_iam_group data source.
...
func groupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::IAM::Group",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::IAM::Group").WithTerraformTypeName("bytepluscc_iam_group")
