...
func init() {
	registry.AddDataSourceFactory("bytepluscc_iam_policy", policyDataSource)
}

// policyDataSource returns the Terraform bytepluscc_iam_policy data source.
...
func policyDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::IAM::Policy",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::IAM::Policy").WithTerraformTypeName("bytepluscc_iam_policy")
