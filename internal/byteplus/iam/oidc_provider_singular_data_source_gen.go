...
func init() {
	registry.AddDataSourceFactory("bytepluscc_iam_oidc_provider", oidcProviderDataSource)
}

// oidcProviderDataSource returns the Terraform bytepluscc_iam_oidc_provider data source.
...
func oidcProviderDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::IAM::OidcProvider",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::IAM::OidcProvider").WithTerraformTypeName("bytepluscc_iam_oidc_provider")
