...
func init() {
	registry.AddDataSourceFactory("bytepluscc_iam_role", roleDataSource)
}

// roleDataSource returns the Terraform bytepluscc_iam_role data source.
...
func roleDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::IAM::Role",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::IAM::Role").WithTerraformTypeName("bytepluscc_iam_role")
