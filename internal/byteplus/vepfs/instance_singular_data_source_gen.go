...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vepfs_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_vepfs_instance data source.
// This Terraform data source corresponds to the Cloud Control Byteplus::VEPFS::Instance resource.
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	attributes := map[string]schema.Attribute{ /*START SCHEMA*/
		...
		//	  "properties": {
		//	    "TotalTiB": {
		//	      "description": "文件系统总容量，单位为 TiB。注意：磁盘均衡耗时会根据集群容量、集群负载等因素有所不同，如 PiB 级以上的集群扩容通常需要天级别的磁盘均衡时间，磁盘均衡完成后扩容容量才会生效（并为扩容容量计费）。",
		//	      "type": "integer"
		//	    },
		//	    "UsedGiB": {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEPFS::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEPFS::Instance").WithTerraformTypeName("bytepluscc_vepfs_instance")
