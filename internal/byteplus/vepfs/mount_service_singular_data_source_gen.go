...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vepfs_mount_service", mountServiceDataSource)
}

// mountServiceDataSource returns the Terraform bytepluscc_vepfs_mount_service data source.
...
func mountServiceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VEPFS::MountService",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VEPFS::MountService").WithTerraformTypeName("bytepluscc_vepfs_mount_service")
