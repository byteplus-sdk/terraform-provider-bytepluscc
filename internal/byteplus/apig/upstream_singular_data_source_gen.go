...
func init() {
	registry.AddDataSourceFactory("bytepluscc_apig_upstream", upstreamDataSource)
}

// upstreamDataSource returns the Terraform bytepluscc_apig_upstream data source.
...
func upstreamDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::APIG::Upstream",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::APIG::Upstream").WithTerraformTypeName("bytepluscc_apig_upstream")
