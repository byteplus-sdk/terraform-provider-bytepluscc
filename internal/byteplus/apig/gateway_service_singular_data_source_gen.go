...
func init() {
	registry.AddDataSourceFactory("bytepluscc_apig_gateway_service", gatewayServiceDataSource)
}

// gatewayServiceDataSource returns the Terraform bytepluscc_apig_gateway_service data source.
...
func gatewayServiceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::APIG::GatewayService",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::APIG::GatewayService").WithTerraformTypeName("bytepluscc_apig_gateway_service")
