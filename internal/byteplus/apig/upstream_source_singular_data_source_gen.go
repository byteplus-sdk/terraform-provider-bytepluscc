...
func init() {
	registry.AddDataSourceFactory("bytepluscc_apig_upstream_source", upstreamSourceDataSource)
}

// upstreamSourceDataSource returns the Terraform bytepluscc_apig_upstream_source data source.
...
func upstreamSourceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudControlTypeName("Byteplus::APIG::UpstreamSource").WithTerraformTypeName("bytepluscc_apig_upstream_source")
