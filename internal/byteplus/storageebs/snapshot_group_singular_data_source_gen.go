...
func init() {
	registry.AddDataSourceFactory("bytepluscc_storageebs_snapshot_group", snapshotGroupDataSource)
}

// snapshotGroupDataSource returns the Terraform bytepluscc_storageebs_snapshot_group data source.
...
func snapshotGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::StorageEBS::SnapshotGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::StorageEBS::SnapshotGroup").WithTerraformTypeName("bytepluscc_storageebs_snapshot_group")
