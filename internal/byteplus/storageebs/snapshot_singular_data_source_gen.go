...
func init() {
	registry.AddDataSourceFactory("bytepluscc_storageebs_snapshot", snapshotDataSource)
}

// snapshotDataSource returns the Terraform bytepluscc_storageebs_snapshot data source.
...
func snapshotDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::StorageEBS::Snapshot",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::StorageEBS::Snapshot").WithTerraformTypeName("bytepluscc_storageebs_snapshot")
