...
func init() {
	registry.AddDataSourceFactory("bytepluscc_storageebs_volume", volumeDataSource)
}

// volumeDataSource returns the Terraform bytepluscc_storageebs_volume data source.
...
func volumeDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::StorageEBS::Volume",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::StorageEBS::Volume").WithTerraformTypeName("bytepluscc_storageebs_volume")
