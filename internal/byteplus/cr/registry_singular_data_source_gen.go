...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cr_registry", registryDataSource)
}

// registryDataSource returns the Terraform bytepluscc_cr_registry data source.
...
func registryDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CR::Registry",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CR::Registry").WithTerraformTypeName("bytepluscc_cr_registry")
