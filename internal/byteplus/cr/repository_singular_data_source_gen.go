...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cr_repository", repositoryDataSource)
}

// repositoryDataSource returns the Terraform bytepluscc_cr_repository data source.
// This Terraform data source corresponds to the Cloud Control Byteplus::CR::Repository resource.
func repositoryDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CR::Repository",
