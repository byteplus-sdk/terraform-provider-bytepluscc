...
func init() {
	registry.AddDataSourceFactory("bytepluscc_cr_name_space", nameSpaceDataSource)
}

// nameSpaceDataSource returns the Terraform bytepluscc_cr_name_space data source.
...
func nameSpaceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CR::NameSpace",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CR::NameSpace").WithTerraformTypeName("bytepluscc_cr_name_space")
