...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vke_addon", addonDataSource)
}

// addonDataSource returns the Terraform bytepluscc_vke_addon data source.
...
func addonDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VKE::Addon",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VKE::Addon").WithTerraformTypeName("bytepluscc_vke_addon")
