...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vke_node", nodeDataSource)
}

// nodeDataSource returns the Terraform bytepluscc_vke_node data source.
...
func nodeDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VKE::Node",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VKE::Node").WithTerraformTypeName("bytepluscc_vke_node")
