...
func TestAccByteplusVKEAddonDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::VKE::Addon", "bytepluscc_vke_addon", "test")
...
func TestAccByteplusVKEAddonDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "Byteplus::VKE::Addon", "bytepluscc_vke_addon", "test")
