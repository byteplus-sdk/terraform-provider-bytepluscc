...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vke_cluster", clusterDataSource)
}

// clusterDataSource returns the Terraform bytepluscc_vke_cluster data source.
...
func clusterDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VKE::Cluster",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VKE::Cluster").WithTerraformTypeName("bytepluscc_vke_cluster")
