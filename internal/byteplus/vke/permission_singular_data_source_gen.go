...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vke_permission", permissionDataSource)
}

// permissionDataSource returns the Terraform bytepluscc_vke_permission data source.
...
func permissionDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VKE::Permission",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VKE::Permission").WithTerraformTypeName("bytepluscc_vke_permission")
