...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vke_default_node_pool", defaultNodePoolDataSource)
}

// defaultNodePoolDataSource returns the Terraform bytepluscc_vke_default_node_pool data source.
...
func defaultNodePoolDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VKE::DefaultNodePool",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VKE::DefaultNodePool").WithTerraformTypeName("bytepluscc_vke_default_node_pool")
