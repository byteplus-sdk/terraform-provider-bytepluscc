...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vke_node_pool", nodePoolDataSource)
}

// nodePoolDataSource returns the Terraform bytepluscc_vke_node_pool data source.
...
func nodePoolDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VKE::NodePool",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VKE::NodePool").WithTerraformTypeName("bytepluscc_vke_node_pool")
