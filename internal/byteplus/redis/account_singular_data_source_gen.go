...
func init() {
	registry.AddDataSourceFactory("bytepluscc_redis_account", accountDataSource)
}

// accountDataSource returns the Terraform bytepluscc_redis_account data source.
...
func accountDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Redis::Account",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Redis::Account").WithTerraformTypeName("bytepluscc_redis_account")
