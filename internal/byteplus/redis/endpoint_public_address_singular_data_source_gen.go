...
func init() {
	registry.AddDataSourceFactory("bytepluscc_redis_endpoint_public_address", endpointPublicAddressDataSource)
}

// endpointPublicAddressDataSource returns the Terraform bytepluscc_redis_endpoint_public_address data source.
...
func endpointPublicAddressDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Redis::EndpointPublicAddress",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Redis::EndpointPublicAddress").WithTerraformTypeName("bytepluscc_redis_endpoint_public_address")
