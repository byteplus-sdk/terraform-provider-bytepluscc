...
func init() {
	registry.AddDataSourceFactory("bytepluscc_redis_allow_list", allowListDataSource)
}

// allowListDataSource returns the Terraform bytepluscc_redis_allow_list data source.
...
func allowListDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Redis::AllowList",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Redis::AllowList").WithTerraformTypeName("bytepluscc_redis_allow_list")
