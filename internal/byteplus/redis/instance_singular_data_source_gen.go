...
func init() {
	registry.AddDataSourceFactory("bytepluscc_redis_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_redis_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Redis::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Redis::Instance").WithTerraformTypeName("bytepluscc_redis_instance")
