...
func init() {
	registry.AddDataSourceFactory("bytepluscc_kms_key_ring", keyRingDataSource)
}

// keyRingDataSource returns the Terraform bytepluscc_kms_key_ring data source.
...
func keyRingDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::KMS::KeyRing",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::KMS::KeyRing").WithTerraformTypeName("bytepluscc_kms_key_ring")
