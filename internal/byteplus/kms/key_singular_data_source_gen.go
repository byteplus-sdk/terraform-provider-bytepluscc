...
func init() {
	registry.AddDataSourceFactory("bytepluscc_kms_key", keyDataSource)
}

// keyDataSource returns the Terraform bytepluscc_kms_key data source.
...
func keyDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::KMS::Key",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::KMS::Key").WithTerraformTypeName("bytepluscc_kms_key")
