...
func init() {
	registry.AddDataSourceFactory("bytepluscc_kms_secret", secretDataSource)
}

// secretDataSource returns the Terraform bytepluscc_kms_secret data source.
...
func secretDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::KMS::Secret",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::KMS::Secret").WithTerraformTypeName("bytepluscc_kms_secret")
