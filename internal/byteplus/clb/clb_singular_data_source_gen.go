...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_clb", cLBDataSource)
}

// cLBDataSource returns the Terraform bytepluscc_clb_clb data source.
...
func cLBDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::CLB",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::CLB").WithTerraformTypeName("bytepluscc_clb_clb")
