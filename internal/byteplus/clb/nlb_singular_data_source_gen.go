...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_nlb", nLBDataSource)
}

// nLBDataSource returns the Terraform bytepluscc_clb_nlb data source.
...
func nLBDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::NLB",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::NLB").WithTerraformTypeName("bytepluscc_clb_nlb")
