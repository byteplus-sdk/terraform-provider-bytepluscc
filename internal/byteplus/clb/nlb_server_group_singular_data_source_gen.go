...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_nlb_server_group", nLBServerGroupDataSource)
}

// nLBServerGroupDataSource returns the Terraform bytepluscc_clb_nlb_server_group data source.
...
func nLBServerGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::NLBServerGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::NLBServerGroup").WithTerraformTypeName("bytepluscc_clb_nlb_server_group")
