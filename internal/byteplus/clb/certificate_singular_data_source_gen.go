...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_certificate", certificateDataSource)
}

// certificateDataSource returns the Terraform bytepluscc_clb_certificate data source.
...
func certificateDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::Certificate",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::Certificate").WithTerraformTypeName("bytepluscc_clb_certificate")
