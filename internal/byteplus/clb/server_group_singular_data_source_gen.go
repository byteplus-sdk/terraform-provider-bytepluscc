...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_server_group", serverGroupDataSource)
}

// serverGroupDataSource returns the Terraform bytepluscc_clb_server_group data source.
...
func serverGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::ServerGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::ServerGroup").WithTerraformTypeName("bytepluscc_clb_server_group")
