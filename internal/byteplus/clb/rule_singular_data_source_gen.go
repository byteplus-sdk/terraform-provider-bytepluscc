...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_rule", ruleDataSource)
}

// ruleDataSource returns the Terraform bytepluscc_clb_rule data source.
...
func ruleDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::Rule",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::Rule").WithTerraformTypeName("bytepluscc_clb_rule")
