...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_nlb_security_policy", nLBSecurityPolicyDataSource)
}

// nLBSecurityPolicyDataSource returns the Terraform bytepluscc_clb_nlb_security_policy data source.
...
func nLBSecurityPolicyDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::NLBSecurityPolicy",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::NLBSecurityPolicy").WithTerraformTypeName("bytepluscc_clb_nlb_security_policy")
