...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_acl", aCLDataSource)
}

// aCLDataSource returns the Terraform bytepluscc_clb_acl data source.
...
func aCLDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::ACL",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::ACL").WithTerraformTypeName("bytepluscc_clb_acl")
