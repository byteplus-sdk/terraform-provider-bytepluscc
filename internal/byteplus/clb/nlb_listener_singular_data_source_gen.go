...
func init() {
	registry.AddDataSourceFactory("bytepluscc_clb_nlb_listener", nLBListenerDataSource)
}

// nLBListenerDataSource returns the Terraform bytepluscc_clb_nlb_listener data source.
...
func nLBListenerDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::CLB::NLBListener",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::CLB::NLBListener").WithTerraformTypeName("bytepluscc_clb_nlb_listener")
