...
func init() {
	registry.AddDataSourceFactory("bytepluscc_privatezone_resolver_rule", resolverRuleDataSource)
}

// resolverRuleDataSource returns the Terraform bytepluscc_privatezone_resolver_rule data source.
...
func resolverRuleDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::PrivateZone::ResolverRule",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::PrivateZone::ResolverRule").WithTerraformTypeName("bytepluscc_privatezone_resolver_rule")
