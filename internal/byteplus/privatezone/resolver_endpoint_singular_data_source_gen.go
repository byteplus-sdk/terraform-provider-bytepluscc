...
func init() {
	registry.AddDataSourceFactory("bytepluscc_privatezone_resolver_endpoint", resolverEndpointDataSource)
}

// resolverEndpointDataSource returns the Terraform bytepluscc_privatezone_resolver_endpoint data source.
...
func resolverEndpointDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::PrivateZone::ResolverEndpoint",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::PrivateZone::ResolverEndpoint").WithTerraformTypeName("bytepluscc_privatezone_resolver_endpoint")
