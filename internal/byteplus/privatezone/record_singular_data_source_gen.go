...
func init() {
	registry.AddDataSourceFactory("bytepluscc_privatezone_record", recordDataSource)
}

// recordDataSource returns the Terraform bytepluscc_privatezone_record data source.
...
func recordDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::PrivateZone::Record",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::PrivateZone::Record").WithTerraformTypeName("bytepluscc_privatezone_record")
