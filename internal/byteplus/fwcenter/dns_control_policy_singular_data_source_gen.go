...
func init() {
	registry.AddDataSourceFactory("bytepluscc_fwcenter_dns_control_policy", dnsControlPolicyDataSource)
}

// dnsControlPolicyDataSource returns the Terraform bytepluscc_fwcenter_dns_control_policy data source.
...
func dnsControlPolicyDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::FWCenter::DnsControlPolicy",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::FWCenter::DnsControlPolicy").WithTerraformTypeName("bytepluscc_fwcenter_dns_control_policy")
