...
func init() {
	registry.AddDataSourceFactory("bytepluscc_emr_cluster", clusterDataSource)
}

// clusterDataSource returns the Terraform bytepluscc_emr_cluster data source.
...
func clusterDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::EMR::Cluster",
