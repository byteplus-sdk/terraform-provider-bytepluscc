...
func init() {
	registry.AddDataSourceFactory("bytepluscc_emr_node_group", nodeGroupDataSource)
}

// nodeGroupDataSource returns the Terraform bytepluscc_emr_node_group data source.
...
func nodeGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::EMR::NodeGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::EMR::NodeGroup").WithTerraformTypeName("bytepluscc_emr_node_group")
