...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpn_customer_gateway", customerGatewayDataSource)
}

// customerGatewayDataSource returns the Terraform bytepluscc_vpn_customer_gateway data source.
...
func customerGatewayDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPN::CustomerGateway",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPN::CustomerGateway").WithTerraformTypeName("bytepluscc_vpn_customer_gateway")
