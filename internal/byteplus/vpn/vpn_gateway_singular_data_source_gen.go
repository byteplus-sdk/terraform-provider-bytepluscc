...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpn_vpn_gateway", vPNGatewayDataSource)
}

// vPNGatewayDataSource returns the Terraform bytepluscc_vpn_vpn_gateway data source.
...
func vPNGatewayDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPN::VPNGateway",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPN::VPNGateway").WithTerraformTypeName("bytepluscc_vpn_vpn_gateway")
