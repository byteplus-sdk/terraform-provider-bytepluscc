...
func init() {
	registry.AddDataSourceFactory("bytepluscc_vpn_ssl_vpn_client_cert", sslVpnClientCertDataSource)
}

// sslVpnClientCertDataSource returns the Terraform bytepluscc_vpn_ssl_vpn_client_cert data source.
...
func sslVpnClientCertDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::VPN::SslVpnClientCert",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::VPN::SslVpnClientCert").WithTerraformTypeName("bytepluscc_vpn_ssl_vpn_client_cert")
