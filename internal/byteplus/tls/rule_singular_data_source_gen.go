...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_rule", ruleDataSource)
}

// ruleDataSource returns the Terraform bytepluscc_tls_rule data source.
...
func ruleDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::Rule",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::Rule").WithTerraformTypeName("bytepluscc_tls_rule")
