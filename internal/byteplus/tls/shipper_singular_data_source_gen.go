...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_shipper", shipperDataSource)
}

// shipperDataSource returns the Terraform bytepluscc_tls_shipper data source.
...
func shipperDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::Shipper",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::Shipper").WithTerraformTypeName("bytepluscc_tls_shipper")
