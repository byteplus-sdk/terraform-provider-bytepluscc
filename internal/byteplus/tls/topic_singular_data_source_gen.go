...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_topic", topicDataSource)
}

// topicDataSource returns the Terraform bytepluscc_tls_topic data source.
...
func topicDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::Topic",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::Topic").WithTerraformTypeName("bytepluscc_tls_topic")
