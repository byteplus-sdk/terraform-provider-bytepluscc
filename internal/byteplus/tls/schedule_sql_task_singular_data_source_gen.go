...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_schedule_sql_task", scheduleSqlTaskDataSource)
}

// scheduleSqlTaskDataSource returns the Terraform bytepluscc_tls_schedule_sql_task data source.
...
func scheduleSqlTaskDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::ScheduleSqlTask",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::ScheduleSqlTask").WithTerraformTypeName("bytepluscc_tls_schedule_sql_task")
