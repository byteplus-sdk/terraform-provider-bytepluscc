...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_alarm_notify_group", alarmNotifyGroupDataSource)
}

// alarmNotifyGroupDataSource returns the Terraform bytepluscc_tls_alarm_notify_group data source.
...
func alarmNotifyGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::AlarmNotifyGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::AlarmNotifyGroup").WithTerraformTypeName("bytepluscc_tls_alarm_notify_group")
