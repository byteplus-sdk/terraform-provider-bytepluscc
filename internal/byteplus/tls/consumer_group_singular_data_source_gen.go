...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_consumer_group", consumerGroupDataSource)
}

// consumerGroupDataSource returns the Terraform bytepluscc_tls_consumer_group data source.
...
func consumerGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::ConsumerGroup",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::ConsumerGroup").WithTerraformTypeName("bytepluscc_tls_consumer_group")
