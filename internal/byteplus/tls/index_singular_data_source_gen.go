...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_index", indexDataSource)
}

// indexDataSource returns the Terraform bytepluscc_tls_index data source.
...
func indexDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::Index",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::Index").WithTerraformTypeName("bytepluscc_tls_index")
