...
func init() {
	registry.AddDataSourceFactory("bytepluscc_tls_import_task", importTaskDataSource)
}

// importTaskDataSource returns the Terraform bytepluscc_tls_import_task data source.
...
func importTaskDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::TLS::ImportTask",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::TLS::ImportTask").WithTerraformTypeName("bytepluscc_tls_import_task")
