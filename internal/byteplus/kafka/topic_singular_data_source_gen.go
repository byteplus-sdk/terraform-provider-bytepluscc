...
func init() {
	registry.AddDataSourceFactory("bytepluscc_kafka_topic", topicDataSource)
}

// topicDataSource returns the Terraform bytepluscc_kafka_topic data source.
...
func topicDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Kafka::Topic",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Kafka::Topic").WithTerraformTypeName("bytepluscc_kafka_topic")
