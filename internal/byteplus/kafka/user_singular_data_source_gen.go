...
func init() {
	registry.AddDataSourceFactory("bytepluscc_kafka_user", userDataSource)
}

// userDataSource returns the Terraform bytepluscc_kafka_user data source.
...
func userDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Kafka::User",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Kafka::User").WithTerraformTypeName("bytepluscc_kafka_user")
