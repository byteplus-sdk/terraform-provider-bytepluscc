...
func init() {
	registry.AddDataSourceFactory("bytepluscc_kafka_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_kafka_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::Kafka::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::Kafka::Instance").WithTerraformTypeName("bytepluscc_kafka_instance")
