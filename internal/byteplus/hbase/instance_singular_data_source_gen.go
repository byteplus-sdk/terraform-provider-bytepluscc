...
func init() {
	registry.AddDataSourceFactory("bytepluscc_hbase_instance", instanceDataSource)
}

// instanceDataSource returns the Terraform bytepluscc_hbase_instance data source.
...
func instanceDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	schema := schema.Schema{
		Description: "Data Source schema for Byteplus::HBase::Instance",
		Attributes:  attributes,
	}

	var opts generic.DataSourceOptions

	opts = opts.WithCloudControlTypeName("Byteplus::HBase::Instance").WithTerraformTypeName("bytepluscc_hbase_instance")
