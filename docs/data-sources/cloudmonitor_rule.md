...
page_title: "bytepluscc_cloudmonitor_rule Data Source - terraform-provider-bytepluscc"
subcategory: "CloudMonitor"
description: |-
  Data Source schema for Byteplus::CloudMonitor::Rule
---

# bytepluscc_cloudmonitor_rule (Data Source)
...
- `metas` (Attributes List) Resource list. Up to 10 resource names can be configured. When Comparator is equal or not_equal, there is no limit on the length of the resource name. When Comparator is contain, not_contain, prefix_match, or suffix_match, the resource name cannot exceed 100 characters. (see [below for nested schema](#nestedatt--dimension_conditions--meta_condition--metas))
