...
page_title: "bytepluscc_rdsmysql_allow_list Data Source - terraform-provider-bytepluscc"
subcategory: "RDSMySQL"
description: |-
  Data Source schema for Byteplus::RDSMySQL::AllowList
---

# bytepluscc_rdsmysql_allow_list (Data Source)
...
- `security_group_bind_infos` (Attributes Set) Information about the security group associated with the allowlist. Note: This field cannot be used together with SecurityGroupIds. (see [below for nested schema](#nestedatt--security_group_bind_infos))
