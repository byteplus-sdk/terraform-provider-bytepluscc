...
page_title: "bytepluscc_cr_registry Data Source - terraform-provider-bytepluscc"
subcategory: "CR"
description: |-
  Data Source schema for Byteplus::CR::Registry
---

# bytepluscc_cr_registry (Data Source)
...
- `acl_policies` (Attributes Set) Public IP allowlist list. (see [below for nested schema](#nestedatt--endpoint--acl_policies))
- `enabled` (Boolean) Whether to enable the public endpoint. Values: false: do not enable. true: enable. Default is false.
- `status` (String) Current status of the public endpoint. Parameter values: Enabling: being enabled. Enabled: enabled. Disabling: being disabled. Updating: updating. Failed: failed. Disabled: disabled.
