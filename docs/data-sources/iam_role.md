...
page_title: "bytepluscc_iam_role Data Source - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  Data Source schema for Byteplus::IAM::Role
---

# bytepluscc_iam_role (Data Source)
...
- `policies` (Attributes Set) 角色策略。 (see [below for nested schema](#nestedatt--policies))
- `role_id` (Number) 角色ID。
