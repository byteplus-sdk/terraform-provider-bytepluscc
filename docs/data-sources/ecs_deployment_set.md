...
page_title: "bytepluscc_ecs_deployment_set Data Source - terraform-provider-bytepluscc"
subcategory: "ECS"
description: |-
  Data Source schema for Byteplus::ECS::DeploymentSet
---

# bytepluscc_ecs_deployment_set (Data Source)
...
- `capacities` (Attributes Set) 实例启动模板版本信息。 (see [below for nested schema](#nestedatt--capacities))
