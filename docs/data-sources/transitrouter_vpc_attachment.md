...
page_title: "bytepluscc_transitrouter_vpc_attachment Data Source - terraform-provider-bytepluscc"
subcategory: "TransitRouter"
description: |-
  Data Source schema for Byteplus::TransitRouter::VpcAttachment
---

# bytepluscc_transitrouter_vpc_attachment (Data Source)
...
- `attach_points` (Attributes Set) 网络实例连接列表。 (see [below for nested schema](#nestedatt--attach_points))
...
- `network_interface_id` (String) 连接点的网卡ID。
