---
page_title: "bytepluscc_rdsmysql_endpoint Resource - terraform-provider-bytepluscc"
...
# bytepluscc_rdsmysql_endpoint (Resource)
...
```shell
$ terraform import bytepluscc_rdsmysql_endpoint.example "instance_id|endpoint_id"
```