---
page_title: "bytepluscc_tls_index Resource - terraform-provider-bytepluscc"
subcategory: "TLS"
description: |-
...
```shell
$ terraform import bytepluscc_tls_index.example "topic_id"
```
