---
page_title: "bytepluscc_rdsmssql_allow_list Resource - terraform-provider-bytepluscc"
subcategory: "RDSMsSQL"
description: |-
  API request parameter - Create RDS SQL Server allowlist (CreateAllowList)
---

# bytepluscc_rdsmssql_allow_list (Resource)
...
```shell
$ terraform import bytepluscc_rdsmssql_allow_list.example "allow_list_id"
```