---
page_title: "bytepluscc_vpc_eip Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
...
```shell
$ terraform import bytepluscc_vpc_eip.example "allocation_id"
```