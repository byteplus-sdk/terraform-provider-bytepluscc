---
page_title: "bytepluscc_emr_cluster Resource - terraform-provider-bytepluscc"
subcategory: "EMR"
description: |-
...
# bytepluscc_emr_cluster (Resource)
...
```terraform
resource "bytepluscc_emr_cluster" "EMRClusterDemo" {
...
```shell
$ terraform import bytepluscc_emr_cluster.example "cluster_id"
```
