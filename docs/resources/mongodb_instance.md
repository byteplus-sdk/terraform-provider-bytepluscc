---
page_title: "bytepluscc_mongodb_instance Resource - terraform-provider-bytepluscc"
subcategory: "MongoDB"
description: |-
...
# bytepluscc_mongodb_instance (Resource)
...
```shell
$ terraform import bytepluscc_mongodb_instance.example "instance_id"
```