...
# bytepluscc_transitrouter_vpn_attachment (Resource)
...
```shell
$ terraform import bytepluscc_transitrouter_vpn_attachment.example "transit_router_id|transit_router_attachment_id"
```