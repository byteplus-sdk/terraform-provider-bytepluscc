---
page_title: "bytepluscc_kms_key_material Resource - terraform-provider-bytepluscc"
subcategory: "KMS"
description: |-
...
# bytepluscc_kms_key_material (Resource)
...
```terraform
resource "bytepluscc_kms_key_material" "Example" {
...
```shell
$ terraform import bytepluscc_kms_key_material.example "key_id"
```
