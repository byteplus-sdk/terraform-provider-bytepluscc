---
page_title: "bytepluscc_privatelink_endpoint_service Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  终端节点服务是可以与其他VPC通过终端节点建立私网连接的服务。
---

# bytepluscc_privatelink_endpoint_service (Resource)
...
```shell
$ terraform import bytepluscc_privatelink_endpoint_service.example "service_id"
```