---
page_title: "bytepluscc_vpn_vpn_gateway Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  当您需要通过VPN连接实现私有网络与本地数据中心或其他私有网络之间的通信，您需要先创建一个VPN网关。
---

# bytepluscc_vpn_vpn_gateway (Resource)
...
```shell
$ terraform import bytepluscc_vpn_vpn_gateway.example "vpn_gateway_id"
```