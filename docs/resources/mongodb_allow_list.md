---
page_title: "bytepluscc_mongodb_allow_list Resource - terraform-provider-bytepluscc"
subcategory: "MongoDB"
description: |-
  文档数据库 MongoDB 版实例创建成功后，您可以为实例设置白名单，以允许外部设备访问该实例。本文介绍如何通过控制台设置白名单。
---

# bytepluscc_mongodb_allow_list (Resource)
...
```shell
$ terraform import bytepluscc_mongodb_allow_list.example "allow_list_id"
```