---
page_title: "bytepluscc_rdspostgresql_db_endpoint Resource - terraform-provider-bytepluscc"
...
# bytepluscc_rdspostgresql_db_endpoint (Resource)
...
```shell
$ terraform import bytepluscc_rdspostgresql_db_endpoint.example "instance_id|endpoint_id"
```