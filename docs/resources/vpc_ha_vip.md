---
page_title: "bytepluscc_vpc_ha_vip Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
...
# bytepluscc_vpc_ha_vip (Resource)
...
```shell
$ terraform import bytepluscc_vpc_ha_vip.example "ha_vip_id"
```