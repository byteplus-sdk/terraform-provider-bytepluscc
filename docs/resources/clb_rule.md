---
page_title: "bytepluscc_clb_rule Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  转发规则用于将指定域名和URL的请求引流至指定的后端服务器组。
---

# bytepluscc_clb_rule (Resource)
...
```shell
$ terraform import bytepluscc_clb_rule.example "listener_id|rule_id"
```