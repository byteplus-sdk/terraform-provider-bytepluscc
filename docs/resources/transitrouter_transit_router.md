---
page_title: "bytepluscc_transitrouter_transit_router Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  中转路由器服务的运行载体。接受来自网络实例的流量，并根据关联转发路由表进行转发。
---

# bytepluscc_transitrouter_transit_router (Resource)
...
```shell
$ terraform import bytepluscc_transitrouter_transit_router.example "transit_router_id"
```