---
page_title: "bytepluscc_kafka_instance Resource - terraform-provider-bytepluscc"
subcategory: "Kafka"
description: |-
...
# bytepluscc_kafka_instance (Resource)
...
```shell
$ terraform import bytepluscc_kafka_instance.example "instance_id"
```