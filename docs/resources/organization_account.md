---
page_title: "bytepluscc_organization_account Resource - terraform-provider-bytepluscc"
...
# bytepluscc_organization_account (Resource)
...
```shell
$ terraform import bytepluscc_organization_account.example "account_id"
```