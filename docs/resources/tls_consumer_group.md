---
page_title: "bytepluscc_tls_consumer_group Resource - terraform-provider-bytepluscc"
subcategory: "TLS"
description: |-
...
# bytepluscc_tls_consumer_group (Resource)
...
```shell
$ terraform import bytepluscc_tls_consumer_group.example "project_id|consumer_group_name"
```
