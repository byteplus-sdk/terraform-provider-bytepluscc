---
page_title: "bytepluscc_vke_permission Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  容器服务提供集群 RBAC 授权功能，为 IAM 用户或角色授予 RBAC 访问权限，包括可访问的资源、权限的作用范围、预置的角色类型等，从而更好地管理集群的安全访问控制，满足企业用户细粒度的资源访问权限控制需求。
---

# bytepluscc_vke_permission (Resource)
...
```shell
$ terraform import bytepluscc_vke_permission.example "permission_id"
```