---
page_title: "bytepluscc_vpc_prefix_list Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  前缀列表是一组CIDR地址块的集合，用于简化安全组规则、路由表条目的配置。当前缀列表修改时，所有关联它的资源均会同步修改。
---

# bytepluscc_vpc_prefix_list (Resource)
...
```shell
$ terraform import bytepluscc_vpc_prefix_list.example "prefix_list_id"
```