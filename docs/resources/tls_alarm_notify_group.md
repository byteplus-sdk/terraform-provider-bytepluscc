---
page_title: "bytepluscc_tls_alarm_notify_group Resource - terraform-provider-bytepluscc"
subcategory: "TLS"
description: |-
...
# bytepluscc_tls_alarm_notify_group (Resource)
...
```terraform
resource "bytepluscc_tls_alarm_notify_group" "TLSAlarmNotifyGroupDemo" {
