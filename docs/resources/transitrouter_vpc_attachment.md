---
page_title: "bytepluscc_transitrouter_vpc_attachment Resource - terraform-provider-bytepluscc"
...
# bytepluscc_transitrouter_vpc_attachment (Resource)
...
```shell
$ terraform import bytepluscc_transitrouter_vpc_attachment.example "transit_router_id|transit_router_attachment_id"
```