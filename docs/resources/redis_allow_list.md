---
page_title: "bytepluscc_redis_allow_list Resource - terraform-provider-bytepluscc"
subcategory: "Redis"
description: |-
...
# bytepluscc_redis_allow_list (Resource)
...
```shell
$ terraform import bytepluscc_redis_allow_list.example "allow_list_id"
```
