---
page_title: "bytepluscc_natgateway_snatentry Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
...
# bytepluscc_natgateway_snatentry (Resource)
...
```shell
$ terraform import bytepluscc_natgateway_snatentry.example "snat_entry_id"
```