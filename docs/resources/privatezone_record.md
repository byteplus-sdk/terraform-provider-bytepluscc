---
page_title: "bytepluscc_privatezone_record Resource - terraform-provider-bytepluscc"
subcategory: "PrivateZone"
description: |-
  A DNS record maps a domain name to resource information within a VPC.
---

# bytepluscc_privatezone_record (Resource)
...
```shell
$ terraform import bytepluscc_privatezone_record.example "record_id"
```