---
page_title: "bytepluscc_ark_endpoint Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
...
# bytepluscc_ark_endpoint (Resource)
...
```shell
$ terraform import bytepluscc_ark_endpoint.example "endpoint_id"
```