---
page_title: "bytepluscc_privatezone_resolver_rule Resource - terraform-provider-bytepluscc"
subcategory: "PrivateZone"
description: |-
  转发规则详细信息
---

# bytepluscc_privatezone_resolver_rule (Resource)
...
```shell
$ terraform import bytepluscc_privatezone_resolver_rule.example "rule_id"
```