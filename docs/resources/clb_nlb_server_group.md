---
page_title: "bytepluscc_clb_nlb_server_group Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  服务器组是一组后端服务器。
---

# bytepluscc_clb_nlb_server_group (Resource)
...
```shell
$ terraform import bytepluscc_clb_nlb_server_group.example "server_group_id"
```