---
page_title: "bytepluscc_natgateway_nat_ip Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  从私网NAT网关所属子网分配，用于IP地址转换。
---

# bytepluscc_natgateway_nat_ip (Resource)
...
```shell
$ terraform import bytepluscc_natgateway_nat_ip.example "nat_ip_id"
```