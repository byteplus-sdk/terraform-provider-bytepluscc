---
page_title: "bytepluscc_vpn_customer_gateway Resource - terraform-provider-bytepluscc"
subcategory: "VPN"
description: |-
...
# bytepluscc_vpn_customer_gateway (Resource)
...
```shell
$ terraform import bytepluscc_vpn_customer_gateway.example "customer_gateway_id"
```