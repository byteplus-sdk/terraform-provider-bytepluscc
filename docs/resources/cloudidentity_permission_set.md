---
page_title: "bytepluscc_cloudidentity_permission_set Resource - terraform-provider-bytepluscc"
...
# bytepluscc_cloudidentity_permission_set (Resource)
...
```shell
$ terraform import bytepluscc_cloudidentity_permission_set.example "permission_set_id"
```