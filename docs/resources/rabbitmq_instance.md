---
page_title: "bytepluscc_rabbitmq_instance Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
...
# bytepluscc_rabbitmq_instance (Resource)
...
```shell
$ terraform import bytepluscc_rabbitmq_instance.example "instance_id"
```