---
page_title: "bytepluscc_rdsmysql_backup Resource - terraform-provider-bytepluscc"
...
# bytepluscc_rdsmysql_backup (Resource)
...
```shell
$ terraform import bytepluscc_rdsmysql_backup.example "instance_id|backup_id"
```