---
page_title: "bytepluscc_cloudidentity_user_provisioning Resource - terraform-provider-bytepluscc"
...
# bytepluscc_cloudidentity_user_provisioning (Resource)
...
```shell
$ terraform import bytepluscc_cloudidentity_user_provisioning.example "user_provisioning_id"
```