---
page_title: "bytepluscc_rdsmysql_instance Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
...
# bytepluscc_rdsmysql_instance (Resource)
...
```shell
$ terraform import bytepluscc_rdsmysql_instance.example "instance_id"
```