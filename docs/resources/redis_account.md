---
page_title: "bytepluscc_redis_account Resource - terraform-provider-bytepluscc"
subcategory: "Redis"
description: |-
...
# bytepluscc_redis_account (Resource)
...
```shell
$ terraform import bytepluscc_redis_account.example "instance_id|account_name"
```