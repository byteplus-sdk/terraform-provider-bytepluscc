---
page_title: "bytepluscc_rdspostgresql_database Resource - terraform-provider-bytepluscc"
...
# bytepluscc_rdspostgresql_database (Resource)
...
```shell
$ terraform import bytepluscc_rdspostgresql_database.example "instance_id|db_name"
```