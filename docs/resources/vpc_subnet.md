---
page_title: "bytepluscc_vpc_subnet Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  子网是在指定可用区内分配的一段VPC网段内的网段，它为云上资源（如云服务器、负载均衡等）提供私网IP地址。
---

# bytepluscc_vpc_subnet (Resource)
...
```shell
$ terraform import bytepluscc_vpc_subnet.example "subnet_id"
```