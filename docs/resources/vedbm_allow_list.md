---
page_title: "bytepluscc_vedbm_allow_list Resource - terraform-provider-bytepluscc"
subcategory: "VEDBM"
description: |-
  vedbm access allowlist.
---

# bytepluscc_vedbm_allow_list (Resource)
...
```shell
$ terraform import bytepluscc_vedbm_allow_list.example "allow_list_id"
```