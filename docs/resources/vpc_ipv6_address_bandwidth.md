---
page_title: "bytepluscc_vpc_ipv6_address_bandwidth Resource - terraform-provider-bytepluscc"
subcategory: "VPC"
description: |-
...
# bytepluscc_vpc_ipv6_address_bandwidth (Resource)
...
```shell
$ terraform import bytepluscc_vpc_ipv6_address_bandwidth.example "allocation_id"
```