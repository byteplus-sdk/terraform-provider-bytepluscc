---
page_title: "bytepluscc_vedbm_database Resource - terraform-provider-bytepluscc"
subcategory: "VEDBM"
description: |-
  Cloud Database Management
---

# bytepluscc_vedbm_database (Resource)
...
```shell
$ terraform import bytepluscc_vedbm_database.example "instance_id|db_name"
```
