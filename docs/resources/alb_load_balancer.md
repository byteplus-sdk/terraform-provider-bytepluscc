---
page_title: "bytepluscc_alb_load_balancer Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  应用型负载均衡（ALB）是对“七层”网络协议的流量进行分发的服务。
---

# bytepluscc_alb_load_balancer (Resource)
...
```shell
$ terraform import bytepluscc_alb_load_balancer.example "load_balancer_id"
```