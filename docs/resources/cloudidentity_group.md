---
page_title: "bytepluscc_cloudidentity_group Resource - terraform-provider-bytepluscc"
...
# bytepluscc_cloudidentity_group (Resource)
...
```shell
$ terraform import bytepluscc_cloudidentity_group.example "group_id"
```