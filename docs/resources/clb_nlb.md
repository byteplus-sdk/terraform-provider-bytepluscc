---
page_title: "bytepluscc_clb_nlb Resource - terraform-provider-bytepluscc"
subcategory: ""
description: |-
  NLB 实例用于接收用户的访问请求，并根据监听器和服务器组的配置设定，将访问请求转发至后端服务器。
---

# bytepluscc_clb_nlb (Resource)
...
```shell
$ terraform import bytepluscc_clb_nlb.example "load_balancer_id"
```