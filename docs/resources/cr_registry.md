---
page_title: "bytepluscc_cr_registry Resource - terraform-provider-bytepluscc"
subcategory: "CR"
description: |-
...
# bytepluscc_cr_registry (Resource)
...
- `acl_policies` (Attributes Set) Public IP allowlist list.
...
```shell
$ terraform import bytepluscc_cr_registry.example "name"
```