---
page_title: "bytepluscc_alb_health_check_template Resource - terraform-provider-bytepluscc"
subcategory: "ALB"
description: |-
...
# bytepluscc_alb_health_check_template (Resource)
...
```shell
$ terraform import bytepluscc_alb_health_check_template.example "health_check_template_id"
```