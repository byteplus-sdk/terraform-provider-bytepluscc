---
page_title: "bytepluscc_kafka_allow_list Resource - terraform-provider-bytepluscc"
subcategory: "Kafka"
description: |-
...
# bytepluscc_kafka_allow_list (Resource)
...
```shell
$ terraform import bytepluscc_kafka_allow_list.example "allow_list_id"
```